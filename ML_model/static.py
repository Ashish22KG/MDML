...
capabilities_rules = r'E:\Malware Detection\final-year-project\auxiliary\Yara rules\capabilities\capabilities.yar'

# Packers

packer_compiler_rules = r'E:\Malware Detection\final-year-project\auxiliary\Yara rules\packers\packer_compiler_signatures.yar'
...
class PEFile:
    ...
    def __init__(self, filename):
        ...
        capabilities = capabilities_rules.match(filename._str_())
    ...
    def Build(self):
        item = {}
        for attr, k in self._dict_.items():
            item[attr] = k
        return item
...
if not os.path.exists(r'E:\Final Project\model\static.joblib'):
    model, target_names, features, scaler = train_model()
    joblib.dump(model, r'E:\Final Project\model\static.joblib')
    joblib.dump(target_names, r'E:\Final Project\label\static.joblib')
    joblib.dump(features, r'E:\Final Project\features\static.joblib' )
    joblib.dump(scaler, r'E:\Final Project\model\static_scaler.joblib')
else:
    target_names = joblib.load(r'E:\Final Project\label\static.joblib')
    model = joblib.load(r'E:\Final Project\model\static.joblib')
    features = joblib.load(r'E:\Final Project\features\static.joblib')    
    scaler = joblib.load(r'E:\Final Project\model\static_scaler.joblib')
